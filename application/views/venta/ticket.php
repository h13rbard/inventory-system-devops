...
<table border="0" align="center" style="table-layout: fixed; width: 260px;">
	...
	<tr>
		...
		<?php echo 'TICKET: '.$enc->folio; ?><br>
		<?=$enc->pago=='CON' ? 'VENTA DE CONTADO' : 'VENTA A CREDITO'?>
        </td>
    </tr>
	<!-- <tr>
        <td align="center" colspan="2">
...
<table align="center" style="table-layout: fixed; width: 250px;">
    ...
    <tr>
        <td align="left" valign="top" style="padding-top: 5px;"><?= $partida->clave_art ?></td>
        <td align="center" colspan="2" style="padding-top: 5px;"><?= $partida->descrip ?></td>
        <!-- <td align="right" style="padding-top: 5px;"></td> -->
    </tr>
	<tr>
        <td align="right" style="padding-top: 5px;"><?= number_format($partida->cantidad, 2) ?></td>
        <td align="left" style="padding-top: 5px;">X <?= number_format($partida->precio, 2) ?></td>
