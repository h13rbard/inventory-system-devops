  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <input type="hidden" value="" name="id"/>
            ...
            <input type="text" class="form-control form-control-sm" id="clave" name="clave" maxlength="5" autocomplete="off" required>
          </div> 

		  <div class="form-group">
            <label for="formato" class="col-form-label">Formato:</label>
            <textarea name="formato" id="" cols="30" rows="10" class="form-control"></textarea>
          </div>
