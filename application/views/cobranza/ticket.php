...
<table align="center" style="table-layout: fixed; width: 250px;">
    ...
    <tr>
        <td align="left" valign="top" style="padding-top: 5px;"><?= $partida->movimiento.' '.$partida->fecha ?></td>
        <td align="center" style="padding-top: 5px;"><?= $partida->cliente ?></td>
    ...
    <tr>
    <td colspan="3" align="center" style="font-size: 100%;">SALDO: $ <?php echo number_format($total_abono-$total_cargo,2);  ?></td>
    </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
    </tr>
