...
table = $("#dtRegistros").DataTable({
        ...
        ajax: {
            "url": "<?=base_url()?>resultadossemanales/datatable",
            "type": "POST",
        },
        columns: [ 
            { data: "id" },
...
function edit(id)
{
    ...
    $.ajax({
    url : "<?php echo site_url('resultadossemanales/ajax_edit/')?>" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
		...
		$('[name="venta_con"]').val(data.venta_con);
		$('[name="venta_cre"]').val(data.venta_cre);
		$('[name="venta_total"]').val(data.venta_total);
		$('[name="sueldo"]').val(data.sueldo);
		$('[name="compras"]').val(data.compras);
		$('[name="gastos"]').val(data.gastos);
		$('[name="desecho"]').val(data.desecho);
		$('[name="cobranza"]').val(data.cobranza);
...
function save()
{
    ...
    if(save_method == 'add')
    {
    url = "<?php echo site_url('resultadossemanales/ajax_add')?>";
    }
    else
    {
    url = "<?php echo site_url('resultadossemanales/ajax_update')?>";
    }
